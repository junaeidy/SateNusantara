...
<head>
    ...
    <title>Login - Sate Nusantara</title>
...
<body class="bg-gradient-primary">
    ...
    <script>
        @if(session()->has('flasher.notification'))
            var notification = @json(session('flasher.notification'));
            Flasher.notification(notification);
        @endif
    </script>
</body>
